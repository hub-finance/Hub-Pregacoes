...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'O sermão inteiro vive nesse painel único: não há mais campo separado de Observações. O que você quiser comentar entra como um bloco, no lugar onde faz sentido. O que já estava escrito nas Observações foi trazido para o fim do sermão.',
