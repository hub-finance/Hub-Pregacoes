  ...
  return (
    <div className="page page-wide">
      <PageHeader
        ...
        lead="Sermões, Rhema, cursos e materiais de liderança reunidos."
        actions={
      ...
      {!filtered.length ? (
        <EmptyState
          ...
          description="Tudo o que você criar em sermões, Rhema, cursos e materiais aparece aqui, com busca e filtros."
          action={
